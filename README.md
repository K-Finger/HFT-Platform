...
[![CI](https://github.com/K-Finger/binance-market-feed/actions/workflows/ci.yml/badge.svg)](https://github.com/K-Finger/binance-market-feed/actions/workflows/ci.yml)
...
```sh
git clone --recurse-submodules https://github.com/K-Finger/binance-market-feed.git
cd binance-market-feed
